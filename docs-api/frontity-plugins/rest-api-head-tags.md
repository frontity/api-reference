...
{% hint style="warning" %}
If you are using Yoast SEO version 14.0 or later, we recommend that you use the [`@frontity/yoast`](../frontity-packages/features-packages/yoast.md) package instead.
{% endhint %}

## Table of Contents

- [Prerequisites](rest-api-head-tags.md#prerequisites)
